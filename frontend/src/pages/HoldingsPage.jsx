    ...
    <div className="space-y-6">
      ...
      <div className="glass-card rounded-2xl p-6 flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div className="min-w-0">
          <h2 className="text-xl font-bold text-slate-900 dark:text-slate-100">Investment Holdings Management</h2>
          <p className="text-xs text-slate-500 dark:text-slate-400 mt-1">
            Total Invested: <span className="text-slate-800 dark:text-slate-200 font-semibold font-mono">{formatCurrency(summary?.totalInvestedAmount)}</span>{' '}
            | Current Portfolio Value: <span className="text-emerald-600 dark:text-emerald-400 font-bold font-mono">{formatCurrency(summary?.totalPortfolioValue)}</span>
          </p>
        </div>
        ...
        <div className="flex items-center gap-3 flex-shrink-0">
          <button
            ...
            className="px-3.5 py-2 rounded-xl bg-white border border-slate-200 hover:border-slate-300 text-slate-700 text-xs font-semibold flex items-center gap-2 transition-all dark:bg-slate-900 dark:border-slate-800 dark:hover:border-slate-700 dark:text-slate-200"
          >
